 ...
 *
 * dist/ext: binaries are per-file symlinks into legacy-mirror/assets (heavy
...
// binaries are per-file symlinks into legacy-mirror/assets (heavy bytes stay
...
const SRC = join(ROOT, 'legacy-mirror', 'assets');
